					...
					<Col xl={20} lg={20} md={20} sm={24} xs={24}>
						{Account ? (
							<h5 className="gx-mb-2 text-ellipsis">
								{Account.product_name} - {Account.product_day} <IntlMessages id="account.profile.product.unit.days" /> {Account.product_night} <IntlMessages id="account.profile.product.unit.nights" />
							</h5>
						) : null}
					</Col>
