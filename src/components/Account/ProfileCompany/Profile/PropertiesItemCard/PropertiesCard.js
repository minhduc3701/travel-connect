		...
		return (
			<div className="block-w">
				...
				{loader ? (
					...
					<p className="gx-font-weight-light"><i className="icon icon-sweet-alert"></i>{" "}
						<IntlMessages id="guide.company.product" /><b>B2B Marketplace</b> > <b><IntlMessages id="sidebar.b2b.service.inventory" /></b>
					</p>
				) : (
