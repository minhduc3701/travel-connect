        ...
        return (
            <div className="m-b-5">
                ...
                <div className="bg-color-white d-flex d-flex-wrap">
                        ...
                        <div className="block__banner__avatar__extend">
                            <div className="text-align-center">
                                <div className="d-inline-block text-align-left">
                                    <h5 className=" gx-text-grey m-b-0-i"><Icon type="usergroup-add" className="p-r-1" /> 254 Followers</h5>
                                    <h5 className=" gx-text-grey m-b-0-i"><Icon type="eye" className="p-r-1" /> 5.214 Views</h5>
                                </div>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col xl={24} lg={24} md={24} sm={24} xs={24} className="text-align-right p-b-3 p-h-3 pos-rel box d-flex-i d-flex-wrap justify-flex-end">
                        ...
                        <Dropdown overlay={btn_notification_menu} placement="bottomRight" className=" m-t-3-i d-inline-block">
